...
- Webhook endpoint is not authenticated via Clerk (Paddle isn't a logged-in user) — signature verification is the entire trust mechanism here, which is exactly why it can't be skipped or relaxed
