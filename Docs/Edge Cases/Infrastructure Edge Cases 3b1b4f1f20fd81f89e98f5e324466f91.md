...
- **Paddle webhook delivery fails or is delayed** — Paddle retries automatically; SellVia's Reconciliation job (05. Payments) is the backstop that catches anything a retry still misses.
