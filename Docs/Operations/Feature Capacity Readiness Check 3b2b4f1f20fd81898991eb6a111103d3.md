...
- [ ]  **Third-party API limits:** Does this add new Stripe, Clerk, or AI/embeddings API calls in a user-facing (synchronous) path? Is there a rate-limit or cost ceiling on that provider this could approach (11. Analytics → AI / Token Usage Tracking is where AI cost would first show strain)?
