...
- **Platform fee: 2% flat, on every sale, for every merchant. Collected via periodic billing (revised 2026-08-07)** — not a live Stripe split, since SellVia no longer processes the underlying sale (01. Money Flow). Bundled into the same billing-cycle charge as creator commissions owed.
...
- Sale: $68.00, commission rate 20%
- Creator commission: $13.60
- Platform fee (2%): $1.36
- Merchant receives: $53.04
